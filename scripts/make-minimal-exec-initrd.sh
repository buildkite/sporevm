...
sources=(agent true false writeout sleeper counter netcheck)
...
chmod 0755 "${workdir}/root/init" "${workdir}/root/bin/true" "${workdir}/root/bin/false" "${workdir}/root/bin/writeout" "${workdir}/root/bin/sleeper" "${workdir}/root/bin/counter" "${workdir}/root/bin/netcheck"
