...
pull, and named lifecycle create/resume/snapshot. It decodes the same JSON contracts as
the CLI and C ABI, and it requires C ABI version 9 or newer. Go context
